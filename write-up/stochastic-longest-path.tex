...
We propose a very similar heuristic here that we call {\em Maximize Candidate Paths} (MCP) for ease of reference. At a high level, it has the following two step structure:
\begin{enumerate}
...
\begin{table}
	...
	\begin{center}	
		\begin{tabular}{c c c}
                  \toprule
                  & \multicolumn{2}{c}{Time (hours, minutes, seconds)} \\
                  \cmidrule{2-3}
                  DAG size & Normal weights & Gamma weights \\
                  \cmidrule{1-3}
                  $35$ & $41$s & $48$s\\
                  $220$ & $5$m $43$s & $6$m $47$s \\
                  $680$ & $20$m $44$s & $24$m $47$s\\
                  $1540$ & $49$m $56$s & $1$h $0$m $5$s \\
                  $2925$ & $1$h $39$m $54$s & $1$h $59$m $45$s \\
                  $4960$ & $2$h $55$m $35$s & $3$h $29$m $44$s \\
                  $7770$ & $4$h $49$m $42$s & $5$h $42$m $56$s \\
                  $11480$ & $7$h $39$m $4$s & $9$h $0$m $40$s \\
		\bottomrule
		\end{tabular}
		\label{tb.mc_timings}
	\end{center}	
