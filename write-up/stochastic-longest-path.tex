...
\begin{table}
	...
	\end{center}	
      \end{table} % TODO: normal costs only? Update
	...
	\caption{Kamburowski's bounds on the variance for the Cholesky graph set. Reference solutions for normal and Gamma distributed costs given by solid lines.}	
