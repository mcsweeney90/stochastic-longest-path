...
\begin{table}
	...
	\end{center}	
      ...
      Leaving aside the question of how close to normal the longest path distributions appears to be, the more important takeaway is that they appear to be very similar for both choices of weight distribution, as we would both hope and expect. It should however also be emphasized that they aren't identical. This is important when evaluating the quality of the bounds and approximations discussed in the following sections since most of them are agnostic of the weight distributions; it is difficult to determine which of two similar approximate solutions is the more accurate when the true solution may vary.
